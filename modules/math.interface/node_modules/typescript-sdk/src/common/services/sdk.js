...
var SdkService = /** @class */ (function (_super) {
    ...
    SdkService.prototype.cartBigCommerceDelete = function (cardId, itemId) {
        return this["delete"]("/carts/" + cardId + "/items/" + itemId)
            ...
            return r.response;
        }), operators_1.retryWhen(function (errors) { return errors.pipe(operators_1.tap(function (val) { return console.log("Value " + val); }), 
        //restart in 1 seconds
        operators_1.delayWhen(function () { return timer_1.timer(1000); })); }));
    };
