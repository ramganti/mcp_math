...
var CartSynchronize = (function () {
    ...
    CartSynchronize.prototype.detectChangesStoreItemsAndSkyItems = function (itemsSky, itemsStore, currentCountry) {
        ...
        if (restrictedProducts.length) {
            ...
            restrictedProducts.forEach(function (v) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.removeProduct("" + v.Id, true)];
    ...
    CartSynchronize.prototype.addProduct = function (productos) {
        ...
        requestObservable.pipe(operators_1.tap(function (r) { return global_variables_2.SynchronizeActions.$onAdd.next(r); }))
    ...
    CartSynchronize.prototype.editProduct = function (editedProducts) {
        ...
        requestObservable.pipe(operators_1.tap(function (r) { return global_variables_2.SynchronizeActions.$onUpdate.next(r); }))
            .subscribe(function () { return _this.reloadCart(); });
    };
    CartSynchronize.prototype.removeProduct = function (productId, promise) {
        ...
        if (promise) {
            requestObservable.pipe(operators_1.take(1), operators_1.tap(function (r) { return global_variables_2.SynchronizeActions.$onDelete.next(r); })).toPromise()
                .then(function () { return _this.reloadCart(); });
        }
        else
            requestObservable.pipe(operators_1.tap(function (r) { return global_variables_2.SynchronizeActions.$onDelete.next(r); }))
                .subscribe(function () { return _this.reloadCart(); });
    };
    CartSynchronize.prototype.removeCart = function () {
        ...
        requestObservable.pipe(operators_1.tap(function (r) { return global_variables_2.SynchronizeActions.$onRemoveCart.next(r); }))
            .subscribe(function () { return _this.reloadCart(); });
    };
